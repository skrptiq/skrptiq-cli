...
4. Before `git push`: write a summary to `.orchestrator-msg` (hook delivers it)
5. After fixing a GH Issue: comment with commit hash and close (or remove your label for cross-repo issues)
